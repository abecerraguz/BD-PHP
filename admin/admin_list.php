        ...
        <nav class="navbar">
            <div class="container containerNavAdmin">
                ...
                <a class="navbar-brand text-uppercase" href="http://localhost/01-sumativa/proyecto-cms/admin/admin_listado.html">
                    <img src="http://localhost:8080/plantilla-blog/assets/img/blog.png" alt="" width="50">
                ...
                <tbody>
                    <?php
                        ...
                        for ($i = 0; $i < count($publicaciones); $i++) {
                            ...
                            echo "<tr ".parImpar($i).">";
                            echo "<td>{$publicaciones[$i]['id']}</td>
                                <td>{$publicaciones[$i]['titulo']}</td>
                                <td>{$publicaciones[$i]['fecha']}</td>
                                <td>
                                    <div class='buttonAction'>
                                        <a href='admin_editar.html' class='btn-edit'><i class='bi bi-pencil-square me-1'></i>Editar</a>
                                        <a href='#' class='btn-delete'><i class='bi bi-x-circle me-1'></i>Eliminar</a>
                                    </div>
                                </td>
                            </tr>";
                        }
